...
export 'package:ecommerce_app/homepage/homepage.dart';
export 'package:ecommerce_app/homepage/components/appbar.dart';
export 'package:ecommerce_app/homepage/components/search_area.dart';
